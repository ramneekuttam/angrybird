...
public class PauseScreen implements Screen {
    ...
    public PauseScreen(AngryBirds game, int fac) {
        ...
        savebutton = new Texture("ui/save.png");
        this.fac = fac;
    }
    @Override
    public void show() {
    ...
    public void render(float delta) {
        ...
        methods.drawButton(stage.getBatch(), reloadbutton, 600, 400, 200, 200, x, y, () ->{
            game.setScreen(new GameScreen());
        });
        methods.drawButton(stage.getBatch(), savebutton, 900, 400, 200, 200, x, y, () ->{
